...
db.serialize(() => {
  ...
  // Verificar que existan nuevas columnas para bases de datos más antiguas
  ...
  // Verificar que existan nuevas columnas para las bases de datos creadas con versiones anteriores
